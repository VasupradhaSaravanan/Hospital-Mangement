...
<body style="background-color: azure;">
    ...
    <div class="container formContainer">
        <form action="includes/patientregister.inc.php" method="POST">
            ...
            <div class="form-group frm">
                ...
                <input type="text" name="patientname" class="form-control" id="formGroupExampleInput" placeholder="">
            </div>
            <div class="form-group frm">
                <label for="formGroupExampleInput2">Age</label>
                <input type="text" name="age" class="form-control" id="formGroupExampleInput2" placeholder="">
            </div>
            <div class="form-group frm">
                <label for="formGroupExampleInput">Height</label>
                <input type="text" name="height" class="form-control" id="formGroupExampleInput" placeholder="Height in Cms">
            </div>
            <div class="form-group frm">
                <label for="formGroupExampleInput">Weight</label>
                <input type="text" name="weight" class="form-control" id="formGroupExampleInput" placeholder="Weight in Kgs">
            </div>
            <div class="form-group frm">
